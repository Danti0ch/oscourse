...
trap_init(void) {
    ...
    //hpet_enable_interrupts_tim0();
    //hpet_enable_interrupts_tim1();
...
/*
    if(tf->tf_trapno == IRQ_OFFSET + IRQ_TIMER){
        timer_hpet0timer_hpet0.handle_interrupts();
    }
    else if(tf->tf_trapno == IRQ_OFFSET + IRQ_CLOCK){
        timer_hpet0timer_hpet1.handle_interrupts();
    }
*/
